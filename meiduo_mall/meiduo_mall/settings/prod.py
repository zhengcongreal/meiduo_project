...
SECRET_KEY = 'jxl7w#5m*02m3$ay9moi88048f%-4p&50b6c=hfbltn$8%(b%='
...
CACHES = {
    "default": { # 默认存储信息: 存到 0 号库
        ...
        "LOCATION": "redis://47.101.190.130/0",
        "OPTIONS": {
...
# 我们申请时添加的: 登录成功后回调的路径
QQ_REDIRECT_URI = 'http://47.101.190.130:90/oauth_callback.html'
...
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'mvsoiuhxqruobdaa'
# 收件人看到的发件人
